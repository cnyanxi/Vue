//目录的缩放隐藏
function catalogHideOne() {
    document.getElementById("olChangeOne").style.display = "";
    document.getElementById("olChangeTwo").style.display = "none";
    document.getElementById("olChangeThree").style.display = "none";
    document.getElementById("olChangeFour").style.display = "none";
    document.getElementById("olChangeFive").style.display = "none";
    document.getElementById("olChangeSix").style.display = "none";
}

function catalogHideTwo() {
    document.getElementById("olChangeOne").style.display = "none";
    document.getElementById("olChangeTwo").style.display = "";
    document.getElementById("olChangeThree").style.display = "none";
    document.getElementById("olChangeFour").style.display = "none";
    document.getElementById("olChangeFive").style.display = "none";
    document.getElementById("olChangeSix").style.display = "none";
...
function catalogHideThree() {
    document.getElementById("olChangeOne").style.display = "none";
    document.getElementById("olChangeTwo").style.display = "none";
    document.getElementById("olChangeThree").style.display = "";
    document.getElementById("olChangeFour").style.display = "none";
    document.getElementById("olChangeFive").style.display = "none";
    document.getElementById("olChangeSix").style.display = "none";
}

function catalogHideFour() {
    document.getElementById("olChangeOne").style.display = "none";
    document.getElementById("olChangeTwo").style.display = "none";
    document.getElementById("olChangeThree").style.display = "none";
    document.getElementById("olChangeFour").style.display = "";
    document.getElementById("olChangeFive").style.display = "none";
    document.getElementById("olChangeSix").style.display = "none";
}

function catalogHideFive() {
    document.getElementById("olChangeOne").style.display = "none";
    document.getElementById("olChangeTwo").style.display = "none";
    document.getElementById("olChangeThree").style.display = "none";
    document.getElementById("olChangeFour").style.display = "none";
    document.getElementById("olChangeFive").style.display = "";
    document.getElementById("olChangeSix").style.display = "none";
}

function catalogHideSix() {
    document.getElementById("olChangeOne").style.display = "none";
    document.getElementById("olChangeTwo").style.display = "none";
    document.getElementById("olChangeThree").style.display = "none";
    document.getElementById("olChangeFour").style.display = "none";
    document.getElementById("olChangeFive").style.display = "none";
    document.getElementById("olChangeSix").style.display = "";
}
